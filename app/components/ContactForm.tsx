...
// Define types for form data with index signature
interface FormData {
  name: string;
  email: string;
  phone: string;
...
const ContactForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const serviceID = process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || "service_wfincci";
    const templateID = process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || "contact_form";
      ...
      >
        ...
        {success && (
          <motion.p 
            ...
            className="text-green-700 text-center mb-4 font-medium bg-green-50 p-3 rounded-lg"
          >
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12">
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            className={`w-full md:w-auto px-12 py-4 bg-gradient-to-r from-[#17ADA1] to-[#14968C] text-white font-bold rounded-lg shadow-lg transition-all ${
